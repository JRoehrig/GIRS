...
# Dowloaded from https://svn.osgeo.org/gdal/trunk/gdal/swig/python/scripts/gdal_merge.py on 26.04.2015
...
class file_info:
    ...
    def init_from_name(self, filename):
        ...
        Returns 1 on success or 0 if the file can'type be opened.
        """
    ...
    def copy_into(self, t_fh, s_band=1, t_band=1, nodata_arg=None):
        ...
        return raster_copy(s_fh, sw_xoff, sw_yoff, sw_xsize, sw_ysize, s_band,
                           t_fh, tw_xoff, tw_yoff, tw_xsize, tw_ysize, t_band, nodata_arg)
